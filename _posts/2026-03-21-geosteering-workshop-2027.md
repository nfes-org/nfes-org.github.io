...
<div class="hero hero hero-example--linear-gradient" style='height: 600px;'>
  <div class="hero__content">
    <h3>4th Geosteering Workshop by NORCE and NFES</h3>
    <p>19-21 April, 2027 <br> Stavanger, Norway</p>
  </div>
</div>
...
**The 4th Stavanger Geosteering Workshop Keeps its Local Focus and Global Perspective**.
...
Our precious workshops in 2019, 2022, and 2024 each gathered almost 100 experts and got excellent feedback.
...
Abstract submission will open soon. The deadline for abstract submission is end of January 2027.

[Sign-up for updates](https://forms.gle/hzoBmG1sv2hBSEA9A) to be notified when submissions open.

## Sponsorship

To become a sponsor, please contact **Annette Larsen** [alarsen@logtek.no](mailto:alarsen@logtek.no).

Sponsorship packages TBA.
...
* Venkat Jambunathan: program (Petrophysist, Halliburton; VP Program, NFES) [vp_program@nfes.org](mailto:vp_program@nfes.org)
