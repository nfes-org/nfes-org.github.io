...
The confirmation from speakers are updated on October 5.

<table class="nice-table" id="table"><tr>
<th colspan="3"><b>Octrober 31</b></th>
</tr>
<tr>
<td>17:00 - 19:00</td>
...
<td rowspan="3">GW</td>
<td>14:05: Ahmed Zarroug EL Sedeq (Schlumberger) et al.: <b>Optimizing Real-Time GeoSteering and  well placement by utilizing Two state-of-the-art drilling technologies on the Duva complex reservoir structure.</b> </td>
</tr>
<tr>
...
* **GW** Geosteering workflows and their applications: pre-job, real-time, post-job (Session chairs: Nigel Clegg, Alexandra Zaputlyaeva)
* **DA opt** Optimization and decision-making in geosteering (Session chairs: Sergey Alyaev, David Holbrough)
...
* **EM+** Resistivity inversion 1,2,3D and data fusion/integration (Session chairs: Maurizio Mele, Nils Andre Aarseth)
